...
const Journey = () => {
    ...
    return (
        <Container id="resume" className="resume section" data-aos="fade-up" data-aos-delay="100">
            <SectionHeader title="My Journey" description="A comprehensive overview of my academic background and professional journey." />
            <Row>
