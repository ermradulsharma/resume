...
const HeroSection = () => {
    ...
    return (
        <Container fluid className="hero section py-lg-5" id='hero' data-aos="fade-up" data-aos-delay="100">
            <Helmet><link rel="preload" as="image" href={logo} type="image/webp" /></Helmet>
            <Row className="align-items-center flex-md-row flex-column-reverse gap-lg-0 gap-3">
                <Col lg={7} className="hero-content" data-aos="fade-right" data-aos-delay="100">
                ...
                <Col lg={5} className="hero-image text-end" data-aos="fade-left" data-aos-delay="200">
