...
const styles = StyleSheet.create({
    ...
    tableHeader: { backgroundColor: '#e8f5e9', fontFamily: 'Helvetica-Bold' },
...
const OfferLetterDocument = ({ offerData = {} }) => {
    const basicMonthly = Number(offerData.basicMonthly || 15000);
    const hraMonthly = Number(offerData.hraMonthly || 6000);
    const specialMonthly = Number(offerData.specialAllowanceMonthly || 4000);
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.metaRow}>
                    <Text style={styles.refNo}>Ref: {offerData.refNo || "PPI/OFF/2018/0019"}</Text>
                    <Text style={styles.dateText}>Date: {offerData.issueDate || "November 25, 2018"}</Text>
                </View>
                ...
                <View style={styles.titleSection}>
                    ...
                    <Text style={styles.subjectText}>Position: {offerData.designation || "PHP Developer"}</Text>
                </View>
                <Text style={styles.paragraph}>Dear <Text style={styles.boldText}>{offerData.candidateName || "Mradul Sharma"}</Text>,</Text>
                <Text style={styles.paragraph}>We are pleased to offer you employment at <Text style={styles.boldText}>Programming Park InfoTech (Agra)</Text> as <Text style={styles.boldText}>{offerData.designation || "PHP Developer"}</Text>. Your joining date is <Text style={styles.boldText}>{offerData.joiningDate || "December 01, 2018"}</Text>.</Text>
                ...
                <View style={styles.signRow}>
                    <View style={styles.signBox}>
                        <Text style={styles.signatoryRole}>Managing Director</Text>
