...
const constant = { borderColor: '#2e7d32', borderWidth: 2, cellBorderWidth: 1, fontFamily: 'Helvetica-Bold' };
...
const styles = StyleSheet.create({
    ...
    headerRow: { flexDirection: 'row', alignItems: 'stretch', borderBottomWidth: constant.cellBorderWidth, borderBottomColor: constant.borderColor, backgroundColor: '#e8f5e9', padding: 10 },
    companyTitle: { fontSize: 16, fontFamily: constant.fontFamily, color: '#2e7d32' },
    addressText: { fontSize: 10, marginTop: 2 },
    bannerRow: { borderBottomWidth: constant.cellBorderWidth, borderBottomColor: constant.borderColor, paddingVertical: 5, alignItems: 'center', backgroundColor: '#c8e6c9' },
...
const SalarySlipDocument = ({ salaryData = {} }) => {
    const totalEarned = Number(salaryData.basicEarned || 15000) + Number(salaryData.hraEarned || 6000) + Number(salaryData.otherAllowEarned || 2000);
            ...
            <Page size="A4" orientation="landscape" style={styles.page}>
                <View style={styles.outerBox}>
                    <View style={styles.headerRow}>
                        <View>
                            <Text style={styles.companyTitle}>PROGRAMMING PARK INFOTECH</Text>
                            <Text style={styles.addressText}>Civil Lines, Agra, Uttar Pradesh - 282002</Text>
                        </View>
                    </View>

                    <View style={styles.bannerRow}><Text style={styles.bannerTitle}>Salary Slip for the Month of: {salaryData.payMonthYear || "January 2020"}</Text></View>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.cell, styles.col4]}>{salaryData.designation || "PHP Developer"}</Text>
                    </View>
                    ...
                    <View style={styles.tableRow}>
                        <Text style={[styles.cell, styles.eCol1, styles.borderRight]}>Basic Pay</Text>
                        <Text style={[styles.cell, styles.eCol2, styles.borderRight]}>{formatNum(salaryData.basicEarned || 15000)}</Text>
                        <Text style={[styles.cell, styles.eCol3, styles.borderRight]}>Deductions</Text>
                        <Text style={[styles.cell, styles.eCol4]}>-</Text>
                    </View>

                    <View style={styles.tableRow}>
                        <Text style={[styles.cell, styles.eCol1, styles.borderRight]}>House Rent Allowance</Text>
                        <Text style={[styles.cell, styles.eCol2, styles.borderRight]}>{formatNum(salaryData.hraEarned || 6000)}</Text>
                    ...
                    <Text style={styles.footerText}>*** Computer generated salary statement — Programming Park InfoTech ***</Text>
                </View>
            </Page>
        </Document>
    );
