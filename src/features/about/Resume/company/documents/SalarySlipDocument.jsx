...
const styles = StyleSheet.create({
    ...
    // --- EARNINGS / DEDUCTIONS TABLE (5 columns) ---
    eCol1: { width: '25%' },
                ...
                <View style={styles.outerBox}>
                    ...
                    <View style={styles.headerRow}>
                        ...
                        <View style={styles.addressCol}>
                            <Text style={styles.companyTitle}>{salaryData.companyTitle || "W3 INFO SOLUTIONS"}</Text>
                            <Text style={styles.addressText}>{salaryData.companyAddressLine || "Balak Ram colony, Niyawan, Ayodhya"}</Text>
                            <Text style={styles.addressText}>{salaryData.companyTelLine || "Uttarpradesh -224001"}</Text>
                            <Text style={styles.addressText}>Tel No:- {salaryData.companyTel || "+91 6393332800"}</Text>
                        </View>
                    </View>
