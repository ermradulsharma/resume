                        ...
                        <div className="not-found-content py-5">
                            ...
                            <div className="error-message">
                                ...
                                <div className="text-start mb-3">
                                    <h2 className="h4 mb-3 text-muted">What might have happened?</h2>
                                ...
                                <div className="text-start mb-4">
                                    <h2 className="h4 mb-3 text-muted">Here's what you can do:</h2>
                                ...
                                <Row className="g-3">
                                    <Col md={3} sm={6}>
                                        <div className="link-card p-3 border rounded h-100" onClick={() => navigate("/")} style={{ cursor: 'pointer' }}>
                                            ...
                                            <p className="small text-muted mb-0">Start from the beginning</p>
                                        </div>
                                    </Col>
                                    <Col md={3} sm={6}>
                                        <div className="link-card p-3 border rounded h-100" onClick={() => navigate("/portfolio")} style={{ cursor: 'pointer' }}>
                                            ...
                                            <p className="small text-muted mb-0">View my projects</p>
                                        </div>
                                    </Col>
                                    <Col md={3} sm={6}>
                                        <div className="link-card p-3 border rounded h-100" onClick={() => navigate("/blogs")} style={{ cursor: 'pointer' }}>
                                            ...
                                            <p className="small text-muted mb-0">Read technical articles</p>
                                        </div>
                                    </Col>
                                    <Col md={3} sm={6}>
                                        <div className="link-card p-3 border rounded h-100" onClick={() => navigate("/services")} style={{ cursor: 'pointer' }}>
                                            ...
                                            <p className="small text-muted mb-0">Explore what I offer</p>
                                        </div>
                                    </Col>
                                </Row>
                            </div>
